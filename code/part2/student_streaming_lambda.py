...
def lambda_handler(event, context):
    ...
    __TableName__ = 'PTDE2403JacMot-streaming-dynamodb' # <-- Insert your table name
    # Configure Firehose service as part of Step 6
    firehose_name = 'ptde2403jacksonmothapo-deliverystream' # <-- Insert your Firehose name
    # ===================================================================================
